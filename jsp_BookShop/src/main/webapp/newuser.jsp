...
<body>
 <c:choose>
  ...
  <c:when test="${pageContext.request.method=='POST' }">
   <jsp:useBean id="ncb" class="com.sunbeam.beans.NewCustomerBean"></jsp:useBean>
   <jsp:setProperty property="*" name="ncb"/>
   
   <c:choose>
				<c:when test="${ncb.saveCustomer()}">
					<hr>
					...
					<p>
						Please <a href="index.jsp">login here</a> to continue to your
						dashboard.
					</p>
				...
				<c:otherwise>
					...
					<p>
						Click <a href="newuser.jsp">(Register Again)</a> to go
